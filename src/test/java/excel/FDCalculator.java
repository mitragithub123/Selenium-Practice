...
public class FDCalculator {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		String filePath = System.getProperty("user.dir") + "\\testData\\Worksheet.xlsx";
		...
		for (int i = 1; i <= rows; i++) {
			...
			intrestSelect.selectByVisibleText(fre);
			...
			Thread.sleep(3000);
			driver.findElement(By.cssSelector("#principal")).clear();
			driver.findElement(By.cssSelector("#interest")).clear();
			driver.findElement(By.cssSelector("#tenure")).clear();
		}
